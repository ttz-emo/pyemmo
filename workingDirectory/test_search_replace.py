...
# template file names
parameterTempFileName = join(
    rootname, "pyemmo", "script", "parameters_template.pro"
)
machineTempFileName = join(
    rootname, "pyemmo", "script", "machine_template.pro"
)
# script file names
machineFile = join(rootname, "workingDirectory", "test_machine_copy.pro")
paramFile = join(
    rootname, "workingDirectory", "test_machine_parameters_copy.pro"
)
...
with open(machineTempFileName) as tempFile:
