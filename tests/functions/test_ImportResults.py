...
def test_file_exists(file_path):
    ...
    try:
        ...
        os.path.isfile("C:/Users/k54149/Documents/pyemmo/Results/Baukasten/Test_SPMSM/res_Test_SPMSM_Baukast/Ib.dat")
...
def test_datasize_values(file_path):
    ...
    assert_data_array =[[0, 0],
                        [0,0],
                        [0.0008333333333333333, 0],
                        [0.001666666666666667, 0]]
    assert np.array_equal(test_data_array,assert_data_array)," data values are incorrect!"
